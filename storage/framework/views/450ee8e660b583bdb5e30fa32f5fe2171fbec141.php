...
<div id="wapper">
	<div id="content">
        ...
        <?php $__currentLoopData = $vohocsinh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="vohocsinh">
            	<div class="hinhanh"><img src="images/<?php echo e($vo->img); ?>" width="255"/></div>
                <div class="infor">
                	<div class="tensp"><a href="chitietvo&<?php echo e($vo->id); ?>"><?php echo e($vo->tensp); ?></a></div>
                    <div class="masp">Mã sản phẩm: <?php echo e($vo->masp); ?></div>
                    <div class="tinhtrang">Tình trạng:<?php echo e($vo->tinhtrang); ?></div>
                    <div class="luocmua"><img src="images/buy.png" width="14" height="14"/> <?php echo e($vo->luocmua); ?> 
                    	 <span class="luocxem"><img src="images/view.png" width="14" height="14"/> <?php echo e($vo->luocxem); ?></span></div>
                    <div class="gia"><?php echo e($vo->gia); ?>.000 Đ</div>
