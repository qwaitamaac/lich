...
<div id="wapper">
	<div id="content">
        ...
        <?php $__currentLoopData = $sachgiaokhoa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="sanpham">
            	<div class="hinhanh"><img src="images/<?php echo e($sach->img); ?>" width="255"/></div>
                <div class="infor">
                	<div class="tensp"><a href="chitietsach&<?php echo e($sach->id); ?>"><?php echo e($sach->tensp); ?></a></div>
                    <div class="masp">Mã sản phẩm: <?php echo e($sach->masp); ?></div>
                    <div class="tinhtrang">Tình trạng:<?php echo e($sach->tinhtrang); ?></div>
                    <div class="luocmua"><img src="images/buy.png" width="14" height="14"/> <?php echo e($sach->luocmua); ?> 
                    	 <span class="luocxem"><img src="images/view.png" width="14" height="14"/> <?php echo e($sach->luocxem); ?></span></div>
                    <div class="gia"><?php echo e($sach->gia); ?>.000 Đ</div>
